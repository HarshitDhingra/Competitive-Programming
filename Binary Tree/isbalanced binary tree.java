...
public class Main {
  ...
  public static balancepair isbalanced(Node node) {
    ...
    balancepair left = isbalanced(node.left);
    balancepair right = isbalanced(node.right);
  ...
  public static void main(String[] args) throws Exception {
    ...
    boolean ans = isbalanced(root).isbalanced;
